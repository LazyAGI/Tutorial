...
def save_results(exact_score: Any, cosine_score: Any, origin_score: Any,file_path: str) -> None:
    with open(file_path, 'a', encoding='utf-8') as f:
        json.dump({'exact_score': exact_score, 'cosine_score': cosine_score, 'origin_score': origin_score}, f, ensure_ascii=False, indent=2)
...
def caculate_score(eval_set, infer_set):
    ...
    save_results([accu_exact_score/total_score,round(accu_exact_score/total_score,4)*100], 
    [accu_cosin_score/total_score,round(accu_cosin_score/total_score,4)*100], [
        accu_origi_score/total_score,round(accu_origi_score/total_score,4)*100], 'sft_llm_results.jsonl')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='virattt/financial-qa-10K',
...
#    python sft_llm.py --mode="local_infer" --model_path="Qwen2.5-0.5B-Instruct"
#
# 2. Fine-tuning and Evaluation:
#    python sft_llm.py --mode="local_train" --model_path="Qwen2.5-0.5B-Instruct"
#
