...
### 5.2 Pack 训练：提高 token 利用率并减少隐式偏置
...
| ---- | ---- | ------- | --------- | ---------------- | ------- |
| Base | 1000 | 988     | 871       | 0                | 87.1%   |
| SFT  | 1000 | 1000    | 992       | 1                | 99.2%   |
