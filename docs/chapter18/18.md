...
用pipeline生成的数据集得到的dpo的loss结果
![loss_of_ppl_dpo](./assets/loss_of_ppl_dpo.png)

用pipeline生成的数据集得到的dpo的reward结果
![reward_of_ppl_dpo](./assets/reward_of_ppl_dpo.png)
...
| 评估指标 | 训练前 (Origin) | 训练后 (Post-GRPO) | 变化幅度 (Delta) |
| :--- | :--- | :--- | :--- |
| 总测试案例数 | 1319 | 1319 | 0 |
| 正确数量 (Correct) | 271 | 639 | +368 |
| 错误数量 (Incorrect) | 334 | 583 | +249 |
| 缺失答案 (Missing) | 714 | 97 | -617 |
| 最终准确率 (Accuracy) | 20.55% | 48.45% | +27.90% |
