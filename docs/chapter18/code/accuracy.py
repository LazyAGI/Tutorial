...
def main():
    """Main function"""
    predictions_file = "/home/mnt/huangchongjin/LLM/GRPO/cold_sft/sft_dataset/problem_codesft.json"
    ground_truth_file = "/home/mnt/huangchongjin/LLM/GRPO/grpo_dataset/gsm8k_test_converted.jsonl"
    output_file = "/home/mnt/huangchongjin/LLM/GRPO/Qwen2.5-r1-cot-output/accuracy_codesft.json"
    ...
    print("\nSaving results...")
    summary = save_results(accuracy_data, output_file)
    print(f"Results saved to: {output_file}")
    
    print("\n" + "="*80)
    print("Incorrect Examples (first 5):")
    print("="*80)
    incorrect_examples = [r for r in accuracy_data['results'] if not r['is_correct']][:5]
