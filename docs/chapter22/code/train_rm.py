...
# === 配置路径与模型 ===
MODEL_NAME = "gpt2"
OUTPUT_DIR = "/home/mnt/huangchongjin/LazyLLM/rm/reward_model_output"

device = "cuda" if torch.cuda.is_available() else "cpu"
print(f"Using device: {device}")

DATASET_PATH = "/home/mnt/huangchongjin/LazyLLM/rm/dataset/Anthropic___hh-rlhf/default/0.0.0/09be8c5bbc57cb3887f3a9732ad6aa7ec602a1fa"

dataset = load_dataset("arrow", data_files={
    "train": os.path.join(DATASET_PATH, "hh-rlhf-train.arrow"),
}, split="train")
