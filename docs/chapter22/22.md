...
#### 二、 增强与合成类算子 (Synthesis & Augmentation)
...
#### 四、 评测与格式化类算子 (Profiler & Formatter)
...
model = lazyllm.TrainableModule(model_path,target_path='/text2sql/checkpoint')\
    .mode('finetune')\
    .trainset('/train.json')\
