...
4. 9.12 不要作为单独的一节  
5. 8.4、9.5和9.10节中的子小节标题序号注意修改一下  
6. 实验分析和实验结果整合一下放一起不要分开  
7. 代码部分需要增加一些必要的文字描述  
8. 8.9和9.12 不要作为单独的一节  
===
...
```
===
cot_thought 结论为球在 1 号杯，target 却是 「3号」，与推演不一致。
===
...
#### 4 ReasoningAnswerTokenLengthFilter
